        ...
        <v-row>
           <v-col cols="12" md="8"
              offset-md="2" class="top">
                 ...
                 <h3 class="white--text text-center card-title mb-5 ">Registarse</h3>
                     <v-select
                    v-model="tipoCliente"
              ...
              <v-container>
                <v-row>
                  ...
                  <v-col cols="6" lg="6" md="12">
                    ...
                    <v-text-field
                         prepend-inner-icon="mdi-lock"
                         v-model="registrar.confirmPassword" 
...
export default {
  ...
  data: () => ({
    ...
    passwordConfirmationRule() {
      return () =>
        this.password === this.confirmPassword || "Contraseña deben coincidir";
    },
